...
<div class="newmain">
	...
	<div class="content"><USA pagetitleText="The U.S." rotate="78.75deg" next="#page3" prev="#page1"></USA></div>
	<div class="content"><Brazil pagetitleText="Brazil" rotate="67.5deg" next="#page4" prev="#page2"></Brazil></div>
	...
	<div class="content"><Iceland pagetitleText="Iceland" rotate="45deg" next="#page6" prev="#page4"></Iceland></div>
	<div class="content"><Ghana pagetitleText="Ghana" rotate="33.75deg" next="#page7" prev="#page5"></Ghana></div>
